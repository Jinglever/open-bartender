# OpenBartender (Native)

A native macOS application that mimics the functionality of Bartender.
...
2. Add your Terminal (e.g., iTerm or Terminal.app) if running via CLI, or the compiled `OpenBartender` binary.
3. Restart the app.

## Project Structure
- `Sources/App`: Main entry point (`OpenBartenderApp`) and `AppDelegate`.
